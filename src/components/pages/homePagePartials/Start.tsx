...
export default function Start() {
	return (
		<section className="w-full dp:flex pb-[70px] dp:bg-background relative">
			<div className="h-customScreen dp:max-h-[990px] dp:flex w-full">
				...
				<div
					id="home"
					className="p-5 dp:px-10 dp:pb-28 flex flex-col justify-end dp:w-1/2 dp:justify-end dp:items-start gap-4 homepage-background scroll-mt-header"
				>
